...
|                          |                                                                    |
| GameStage                | gets nearest parent GameStage                                      |
|                          |                                                                    |
| virtual MainSubStateRef  | Must return StateRef in case state designerd to have main substate |
see [BindableBehaviour](../../Flexy.Core/Binders.md) for inherited ones
...
|                              |                                                                                                   |
| virtual OnChildOpen          | Event. Happens before child opened                                                                |
| virtual OnChildShow          | Event. Happens before child showed                                                                |
| virtual OnChildClose         | Event. Happens after child hide                                                                   |
| virtual OnChildHide          | Event. Happens after child hide                                                                   |
